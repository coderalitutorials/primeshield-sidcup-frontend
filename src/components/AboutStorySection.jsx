...
//         <img
//           src="/images/about-primeshield-banner.webp"
//           alt="PrimeShield Kensington professional pest control team working across Kensington and South Kensington"
//           className="absolute inset-0 w-full h-full object-cover object-top lg:object-[center_10%]"
//           loading="eager"
//           decoding="async"
//         />
...
//             <p className="mt-7 max-w-2xl text-white/80 text-sm md:text-lg leading-relaxed">
//               Professional pest control support for Kensington homes, landlords
//               and commercial properties from 40 Harrington Rd, South Kensington,
//               London SW7 3ND.
//             </p>
//           </div>
//         </div>
...
//             <div className="lg:col-span-8">
//               <span className="block text-[#F36F21] text-xs font-black uppercase tracking-[0.3em] mb-6">
//                 Our Kensington Story
//               </span>

//               <h2 className="text-[#F36F21] text-3xl sm:text-4xl lg:text-[48px] font-black leading-[1.25] tracking-tight max-w-5xl">
//                 At PrimeShield Kensington, our work is built around protecting
//                 local homes and businesses across Kensington and South
//                 Kensington with reliable, careful and professional pest control
//                 solutions.
//               </h2>
...
//             <div className="lg:col-span-4 bg-white border border-[#F36F21]/15 p-7 md:p-8 shadow-[0_20px_60px_rgba(17,17,17,0.08)]">
//               <p className="text-[#5F5F5F] text-sm md:text-base leading-relaxed">
//                 From our local base at 40 Harrington Rd, South Kensington,
//                 London SW7 3ND, PrimeShield Kensington focuses on clear
//                 inspections, targeted treatment planning and practical
//                 prevention advice for properties throughout the Kensington area.
//               </p>
  ...
  return (
    <>
      ...
      <section className="relative h-[380px] md:h-[460px] lg:h-[540px] overflow-hidden font-sans">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 lg:px-14 h-full flex items-center justify-center text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="mt-7 max-w-2xl mx-auto text-white/80 text-sm md:text-lg leading-relaxed">
              Professional pest control support for Kensington homes, landlords
              and commercial properties from 40 Harrington Rd, South Kensington,
              London SW7 3ND.
            </p>
      ...
      <section className="bg-[#F7F3EF] py-20 md:py-28 relative overflow-hidden font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-14 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h2 className="text-[#F36F21] text-3xl sm:text-4xl lg:text-[48px] font-black leading-[1.25] tracking-tight max-w-5xl mx-auto">
              At PrimeShield Kensington, our work is built around protecting
              local homes and businesses across Kensington and South Kensington
              with reliable, careful and professional pest control solutions.
            </h2>

            <div className="w-24 h-[3px] bg-[#F36F21] mt-8 mx-auto" />

            <div className="mt-12 max-w-3xl mx-auto bg-white border border-[#F36F21]/15 p-7 md:p-8 shadow-[0_20px_60px_rgba(17,17,17,0.08)]">
              <p className="text-[#5F5F5F] text-sm md:text-base leading-relaxed">
                From our local base at 40 Harrington Rd, South Kensington,
                London SW7 3ND, PrimeShield Kensington focuses on clear
                inspections, targeted treatment planning and practical
